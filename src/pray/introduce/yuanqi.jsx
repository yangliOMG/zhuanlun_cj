        ...
        return (
            <div>
                ...
                <div className='gongdeContent'>
                        <p className='c-fuzhu b'>祈福明灯由转轮藏衍变而来。</p>
                ...
                <div className='gongdeContent'>
                    ...
                    塔中有轴，地下设有机关，可以转动。当今汉传佛教寺院内大多设有藏经阁，其建筑形式也是从转轮藏逐渐演变而来。</p>
                        <p className='c-fuzhu b'>祈福明灯的诞生</p>
                        <p className='duanluo'>为恢复建设转轮藏并在寺院中大力推广，天津慈俱在佛教如理如法的基础上，研制结合了集藏经阁、佛龛、祈福供灯、电力自动旋转、手动旋转、LED旋转屏幕和远程无线控制于一体的现代转轮藏——祈福明灯。
